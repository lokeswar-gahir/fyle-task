...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        if (assignment.state == AssignmentStateEnum.DRAFT and auth_principal.principal_id):
            assertions.assert_valid(False, 'drafted assignment cannot be grade by principal')
    ...
    @classmethod
    def get_sumbitted_or_graded(cls):
